...
- when that endpoint fails, the UI labels those metrics as `Demo fallback` instead of pretending they are live.
...
- `Live DataForSEO` means backlink and authority metrics returned by the DataForSEO Backlinks Summary API.
